...
const sections = [
  {
    title: '1. About Education Revolution',
    body: [
      'Education Revolution is an AI-powered learning platform designed for high school and university level students. It helps students organise their studies through features including study planners, assignments, flashcards, quizzes, AI tutoring, study notes, class management, and collaborative learning tools.',
  ...
  },
  {
    ...
    body: [
      'Education Revolution provides integrated group chats and Jitsi meeting facilities to support peer-to-peer study groups.',
  ...
  },
  {
    ...
    body: [
      'Education Revolution includes AI-powered features that generate study materials and educational content based on prompts and uploaded files.',
  ...
  },
  {
    ...
    body: [
      'Education Revolution may use trusted third-party services including Firebase Authentication, Firebase Firestore, Firebase Storage, Google Cloud Platform, Google Sign-In, Jitsi Meet API, Microsoft Word Integration API, AI service providers, analytics, and crash reporting tools.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'Education Revolution is primarily designed for high school and university level students. Middle school students may also use the application with direct parental guidance, supervision, and prior approval.',
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-5 py-10 font-sans text-slate-950">
      <article className="mx-auto max-w-4xl rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/60 sm:p-10">
        ...
        <h1 className="mt-6 text-4xl font-black tracking-tight sm:text-5xl">Education Revolution Privacy Policy</h1>
        ...
        <p className="mt-6 text-lg font-semibold leading-8 text-slate-600">
          Thank you for using Education Revolution. Your privacy is important to us. This Privacy Policy outlines how we manage, protect, and respect your personal information and data privacy across our learning platforms.
        </p>
        ...
        <section className="mt-10 rounded-2xl border border-slate-200 bg-slate-50 p-5">
          ...
          <p className="mt-3 text-base font-medium leading-7 text-slate-600">
            If you have questions regarding this Privacy Policy or your personal information, please contact Education Revolution Support.
          </p>
